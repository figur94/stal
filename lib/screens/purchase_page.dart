...
class ProductsPageListState extends State<ProductsPageList> {
  ...
  Widget _buildBody() {
    List<String> headerTitles = ['Nazwa', 'Waga', 'Długość'];
    return Column(
      children: [
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              TextEditingController weightController = _controllers[filteredItem.name] ?? TextEditingController();
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        ...
                        if (weight != null && length != null) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Please enter valid weight and length'),
                            ),
                          );
                        }
                      },
